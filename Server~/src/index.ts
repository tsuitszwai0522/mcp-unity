...
import { registerGetGameObjectTool, registerGetGameObjectsByNameTool, registerGetGameObjectsByComponentTool } from './tools/getGameObjectTool.js';
...
registerGetTestRunTool(server, mcpUnity, toolLogger);
...
registerGetGameObjectsByNameTool(server, mcpUnity, toolLogger);
registerGetGameObjectsByComponentTool(server, mcpUnity, toolLogger);
...
registerWireUnityEventTool(server, mcpUnity, toolLogger);
